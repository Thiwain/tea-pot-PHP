                ...
                <div class="card position-sticky top-0">
                   ...
                   ");
                        ...
                        <div class="d-flex justify-content-between mb-1 small">
                            <span>Subtotal</span> <span><?php echo $total; ?> LKR</span>
                        </div>
                        <?php
                        ...
                        ?>
                        <div class="d-flex justify-content-between mb-1 small">
                            <span>Shipping</span> <span><?php echo $charge; ?> LKR</span>
                        </div>

                        <hr>
                        <div class="d-flex justify-content-between mb-4 small">
                            <span>TOTAL</span> <strong class="text-dark"><?php echo $total + $charge; ?> LKR</strong>
                        </div>
                        ...
                        <a href="invoice.php?id=<?php echo ($iid); ?>" class="btn btn-primary w-100 mt-2" type="submit">Place order</a>
