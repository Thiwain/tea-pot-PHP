...
<body>
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4 shadow col-8">
            ...
            <form id="authForm" method="POST" action="authProcess.php">
                <div class="form-group">
                    <label for="authInput">Email</label>
                    <input type="text" class="form-control" id="authInput" name="email" placeholder="Email" required>
                </div>
